  ...
  return (
    <>
      <section className="m-8 flex gap-4">
        <div className="lg:w-3/5 w-full mt-19">
          <img src={logo} alt="hotel-realta.com" className="w-24 mx-auto mb-8 mt-8" />
          <div className="text-center">
            <Typography variant="h2" className="font-bold mb-4">
              Daftar Baru
            </Typography>
            <Typography variant="paragraph" color="blue-gray" className="text-lg font-normal">
              Silahkan masukan data untuk membuat Akun baru.
            </Typography>
          </div>
          ...
          <form onSubmit={signUpHandler} className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
            <div className="mb-1 flex flex-col gap-6">
              ...
              <div className="relative flex w-full max-w-[24rem]">
                <Button size="sm" color="blue-gray" className="flex h-10 items-center gap-2 rounded-r-none border border-r-0 border-blue-gray-200 bg-blue-gray-500/10 pl-3">
